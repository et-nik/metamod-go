...
extern void goHookWriteByte(int i);
extern void goHookWriteChar(int i);
extern void goHookWriteShort(int i);
extern void goHookWriteLong(int i);
extern void goHookWriteAngle(float f);
extern void goHookWriteCoord(float f);
extern void goHookWriteString(const char *s);
extern void goHookWriteEntity(int i);
...
extern edict_t* goHookEntityOfEntIndex(int index);
...
extern void goHookClientPrintf(edict_t *pEdict, PRINT_TYPE ptype, const char *szMsg);
...
void SetHooks(enginefuncs_t *pengfuncsFromEngine) {
	...
	//pengfuncsFromEngine->pfnWriteByte = goHookWriteByte;
	//pengfuncsFromEngine->pfnWriteChar = goHookWriteChar;
	//pengfuncsFromEngine->pfnWriteShort = goHookWriteShort;
	//pengfuncsFromEngine->pfnWriteLong = goHookWriteLong;
	//pengfuncsFromEngine->pfnWriteAngle = goHookWriteAngle;
	//pengfuncsFromEngine->pfnWriteCoord = goHookWriteCoord;
	//pengfuncsFromEngine->pfnWriteString = goHookWriteString;
	//pengfuncsFromEngine->pfnWriteEntity = goHookWriteEntity;
	...
	//pengfuncsFromEngine->pfnPEntityOfEntIndex = goHookEntityOfEntIndex;
	...
	//pengfuncsFromEngine->pfnClientPrintf = goHookClientPrintf;
